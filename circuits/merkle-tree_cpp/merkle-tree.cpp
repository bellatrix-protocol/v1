...
void branch_101_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void branch_101_run(uint ctx_index,Circom_CalcWit* ctx);
void branch_102_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void branch_102_run(uint ctx_index,Circom_CalcWit* ctx);
void branch_103_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void branch_103_run(uint ctx_index,Circom_CalcWit* ctx);
...
void merkleProof_106_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void merkleProof_106_run(uint ctx_index,Circom_CalcWit* ctx);
void sha256compression_0(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void ssigma1_1(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void ssigma0_2(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void bsigma1_3(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void Ch_4(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void sha256K_5(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void bsigma0_6(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void Maj_7(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
void rrot_8(Circom_CalcWit* ctx,FrElement* lvar,FrElement* destination,int destination_size);
Circom_TemplateFunction _functionTable[107] = { 
Bits2Num_0_run,
Num2Bits_1_run,
RotR_2_run,
RotR_3_run,
...
uint get_total_signal_no() {return 1429089;}

uint get_number_of_components() {return 12697;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 208752;}
...
ssigma1_1(ctx,lvarcall,&lvar[1107],1);
// end call bucket
}
...
Fr_copy(&lvarcall[0],&lvar[((1 * Fr_toInt(&expaux[1])) + 1040)]);
// end copying argument 0
ssigma0_2(ctx,lvarcall,&lvar[1108],1);
// end call bucket
}
...
// end copying argument 0
bsigma1_3(ctx,lvarcall,&lvar[1107],1);
// end call bucket
}
...
// end copying argument 0
sha256K_5(ctx,lvarcall,&lvar[1109],1);
// end call bucket
}
...
// end copying argument 0
bsigma0_6(ctx,lvarcall,&lvar[1110],1);
// end call bucket
}
...
// end copying argument 2
Maj_7(ctx,lvarcall,&lvar[1111],1);
// end call bucket
}
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 91. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &lvar[4];
// load src
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 100. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
}
...
// end copying argument 1
sha256compression_0(ctx,lvarcall,&lvar[0],256);
// end call bucket
}
...
PFrElement aux_dest = &signalValues[mySignalStart + (((32 * Fr_toInt(&lvar[258])) + (1 * Fr_toInt(&lvar[257]))) + 17664)];
// load src
Fr_sub(&expaux[1],&lvar[258],&circuitConstants[38]); // line circom 87
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[1])) + 0)]].signalStart + ((1 * Fr_toInt(&lvar[257])) + 0)]);
}
{
PFrElement aux_dest = &lvar[257];
// load src
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 157. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 158. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 159. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 160. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 161. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 162. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 163. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
...
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 164. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &lvar[257];
// load src
...
// load src
Fr_sub(&expaux[0],&circuitConstants[150],&lvar[0]); // line circom 66
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ((1 * Fr_toInt(&expaux[0])) + 0)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
Sha256compression_91_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
Fr_sub(&expaux[0],&circuitConstants[150],&lvar[0]); // line circom 67
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ((1 * Fr_toInt(&expaux[0])) + 0)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
Sha256compression_91_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
Fr_sub(&expaux[0],&circuitConstants[141],&lvar[0]); // line circom 87
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + ((1 * Fr_toInt(&expaux[0])) + 0)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
...
ctx->componentMemory[coffset].templateName = "branch";
ctx->componentMemory[coffset].signalStart = soffset;
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[8]); // line circom 16
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[7]); // line circom 16
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[2])) + 0);
{
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 16
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
ctx->componentMemory[coffset].templateName = "merkleProof";
ctx->componentMemory[coffset].signalStart = soffset;
...
mySubcomponents[aux_create+i] = aux_cmp_num;
branch_103_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
}
}
{
uint aux_create = 1;
int aux_cmp_num = 1816+ctx_index+1;
uint csoffset = mySignalStart+204170;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "layers[1]";
mySubcomponents[aux_create+i] = aux_cmp_num;
branch_102_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
}
}
{
uint aux_create = 2;
int aux_cmp_num = 5443+ctx_index+1;
uint csoffset = mySignalStart+612476;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "layers[2]";
mySubcomponents[aux_create+i] = aux_cmp_num;
branch_101_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
}
}
...
Fr_geq(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 33
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_add(&expaux[4],&lvar[1],&circuitConstants[2]); // line circom 35
Fr_shl(&expaux[2],&circuitConstants[2],&expaux[4]); // line circom 35
Fr_lt(&expaux[0],&lvar[2],&expaux[2]); // line circom 35
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[1],&circuitConstants[7]); // line circom 36
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 33
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_geq(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 33
...
merkleProof_106_create(1,0,ctx,"main",0);
merkleProof_106_run(0,ctx);
}
